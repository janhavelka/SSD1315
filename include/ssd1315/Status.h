...
struct SettingsSnapshot {
  ...
  uint8_t userPageCount = 1; ///< @deprecated Application-page compatibility storage.
  uint8_t activeUserPage = 0; ///< @deprecated Application-page compatibility storage.
  ...
  bool clearOnRecover = true; ///< @deprecated Ignored compatibility storage.
