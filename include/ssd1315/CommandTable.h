...
enum class ScrollSpeed : uint8_t {
  ...
  FRAMES_256 = FRAMES_128,  ///< @deprecated Raw-value alias for FRAMES_128; not SSD1306 compatibility.
  FRAMES_25 = FRAMES_5      ///< @deprecated Raw-value alias for FRAMES_5; not SSD1306 compatibility.
};
