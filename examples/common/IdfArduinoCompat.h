 ...
 * @brief ESP-IDF compatibility layer for the Arduino-shaped SSD1315 CLI.
 *
 * This file is example glue only. It provides the small Serial/timing surface
 * used by examples/01_basic_bringup_cli so the ESP-IDF example can share the
 * same command implementation without linking the Arduino framework.
 */
...
#ifndef SSD1315_EXAMPLE_PLATFORM_IDF
